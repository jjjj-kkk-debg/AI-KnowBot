...
public class ChatController {
    ...
    public ChatController(ConversationService conversationService, CozeService cozeService, AsyncTaskManager taskManager) {
    ...
    @PostMapping("/send")
    public ApiResult<Long> sendMessage(@RequestBody Map<String, Object> body) {
        ...
        return ApiResult.success(conversationService.sendMessageAsync(conversationId, userId, content));
    }
