...
public class ConversationService {
    ...
    public long sendMessageAsync(Long conversationId, String userId, String content) {
        ...
        executor.submit(() -> {
            try {
                ...
                taskManager.completeTask(taskId, aiResponse);
            } catch (Exception e) {
                log.error("Async sendMessage failed", e);
